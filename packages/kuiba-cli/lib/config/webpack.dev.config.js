...
function createHtmlPluginOptions(type) {
    return {
        hash: true,
        chunks: [type],
        title: (0, lodash_1.get)(kuibaConfig, type + ".title[" + (0, lodash_1.get)(kuibaConfig, 'defaultLanguage') + "]"),
        logo: (0, lodash_1.get)(kuibaConfig, "logo"),
        baidu: (0, lodash_1.get)(kuibaConfig, "analysis.baidu", '')
    };
}
function getDevServerConfig() {
    var host = (0, lodash_1.get)(kuibaConfig, 'host');
    return {
        port: (0, lodash_1.get)(kuibaConfig, 'port'),
