...
function compileTypes() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_extra_1.default.ensureDir(constant_1.TYPES_DIR)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, fs_extra_1.default.readdir(constant_1.TYPES_DIR)];
                case 2:
                    dir = _a.sent();
                    ignoreEntryDir = dir.filter(function (fileName) { return fileName !== 'index.d.ts'; });
                    exports = [];
                    ignoreEntryDir.forEach(function (fileName) {
                        var componentName = (0, fsUtils_1.camelize)(fileName.slice(0, fileName.indexOf('.d.ts')));
                        exports.push("export * from './" + componentName + "'");
                    });
                    template = "import type { App } from 'vue'\n\nexport const install: (app: App) => void\n\n" + exports.join('\n') + "\n";
                    return [4 /*yield*/, fs_extra_1.default.writeFile((0, path_1.resolve)(constant_1.TYPES_DIR, 'index.d.ts'), template)];
                case 3:
                    _a.sent();
                    return [2 /*return*/];
            }
