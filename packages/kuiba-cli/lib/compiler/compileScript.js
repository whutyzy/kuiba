        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    code = (0, compileStyle_1.extractStyleDependencies)(file, code, compileStyle_1.IMPORT_SASS_RE, 'scss', false);
                    ...
                    (0, fs_extra_1.writeFileSync)((0, fsUtils_1.replaceExt)(file, '.js'), code, 'utf-8');
                    return [2 /*return*/];
            }
        });
    });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, compileScript(source, file)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function compileLibraryEntry(dir, publicDirs) {
    return __awaiter(this, void 0, void 0, function () {
        var imports, plugins, constInternalComponents, cssImports, sassImports, publicComponents, install, indexTemplate, styleTemplate, umdTemplate, sassTemplate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    imports = [];
                    ...
                    return [4 /*yield*/, Promise.all([
                            ...
                            (0, fs_extra_1.writeFile)((0, path_1.resolve)(dir, 'scss.scss'), sassTemplate, 'utf-8')
                        ])];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
