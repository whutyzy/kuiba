...
export const KUIBA_CONFIG = resolve(CWD, 'kuiba.config.js')
...
export const SITE_DIR = resolve(CWD, '.kuiba/site')
export const SITE_CONFIG = resolve(CWD, '.kuiba/site.config.json')
export const SITE_PC_ROUTES = resolve(CWD, '.kuiba/pc.routes.ts')
export const SITE_MOBILE_ROUTES = resolve(CWD, '.kuiba/mobile.routes.ts')
