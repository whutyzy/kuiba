...
exports.CastSitePlugin = exports.buildSiteEntry = exports.buildPcSiteRoutes = exports.buildMobileSiteRoutes = exports.findRootDocsPaths = exports.getRootDocsRoutePath = exports.getComponentDocsRoutePath = exports.getExampleRoutePath = void 0;
                ...
                case 1:
                    ...
                    collectRoutePath = function (routePaths, fileName) {
                        ...
                        (0, fs_extra_1.readdirSync)(dirPath).forEach(function (mdName) {
                            var mdPath = (0, path_1.resolve)(dirPath, mdName);
                            (0, fsUtils_1.isMD)(mdPath) && routePaths.push((0, slash_1.default)(mdPath));
                        });
                        return routePaths;
                    };
...
var PLUGIN_NAME = 'CastSitePlugin';
var CastSitePlugin = /** @class */ (function () {
    function CastSitePlugin() {
    }
    CastSitePlugin.prototype.apply = function (compiler) {
        if (process.env.NODE_ENV === 'production') {
            compiler.hooks.beforeCompile.tapPromise(PLUGIN_NAME, buildSiteEntry);
        }
        else {
            var watcher = chokidar_1.default.watch([constant_1.SITE_EXAMPLE_GLOB, constant_1.SITE_DOCS_GLOB, constant_1.CAST_CONFIG]);
    ...
    return CastSitePlugin;
}());
exports.CastSitePlugin = CastSitePlugin;
